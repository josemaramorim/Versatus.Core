...
| ENVIARSPED | smallint NO | `EnviarSped` (bool) | **promovida do `[E14]` no E3-T05** (VAL-E3-02..05) |
| CPFCNPJ | varchar(14) YES | `CpfCnpj` (string?) | **promovida do `[E14]` no E3-T05** (VAL-E3-17) |
...
DATAULTIMOENVIO, QUANTIDADEULTIMOENVIO, IDENTIFICACAOEMPRESA, NUMEROCONVENIO,
ULTIMONUMEROARQUIVO, GERABOLETO, GERAREMESSA, PROCESSARETORNO, CODIGOCARTEIRAREMESSA,
