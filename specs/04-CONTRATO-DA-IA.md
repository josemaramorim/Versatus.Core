...
| **MOD-02** | 🚧 Em Progresso | 2.5 (Concluído) | `setup/acesso-global-project` | Localização Geográfica (Pais até TipoLogradouro) pronta. |
...
- Iniciar **Tarefa 2.6 do MOD-02** (Endereco.cs).
