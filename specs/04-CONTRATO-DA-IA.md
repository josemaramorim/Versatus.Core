...
| **MOD-02** | 🚧 Em Progresso | 2.6 (Concluído) | `setup/acesso-global-project` | Entidades de Localização Geográfica (Pais até Endereco) prontas. |
...
- Iniciar **Tarefa 2.7 do MOD-02** (Configurar DbContext).
