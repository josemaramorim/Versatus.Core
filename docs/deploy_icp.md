...
| :--- | :--- | :--- |
| `CONNECTIONSTRINGS__WRITECONNECTION` | `Server=localhost\SQLEXPRESS2008;Database=versatus;User Id=sa;Password=V#v070804s;TrustServerCertificate=True;` | Connection string de Escrita para o banco principal (Master). |
| `CONNECTIONSTRINGS__READCONNECTION` | `Server=localhost\SQLEXPRESS2008;Database=versatus;User Id=sa;Password=V#v070804s;TrustServerCertificate=True;` | Connection string de Leitura para a réplica de banco (Read Replica). |
...
> 💡 **Dica de Preenchimento para `CONNECTIONSTRINGS__WRITECONNECTION` e `CONNECTIONSTRINGS__READCONNECTION` no ICP:**
...
> * 💡 *Se ainda não possuir réplica de leitura separada, preencha ambas as variáveis com o mesmo valor de connection string.*
