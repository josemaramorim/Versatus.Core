...
const AGRUPADOR_NAMES: Record<number, string> = {
  0: 'Geral',
  1: 'Centro de Custos',
  2: 'Movimentações Retroativas',
  3: 'Portadores de Cobrança',
  4: 'Contas a Receber',
  5: 'Contas a Pagar',
  6: 'Cheques Recebidos',
  7: 'Venda Balcão & PDV',
  8: 'Caixa e Tesouraria',
  9: 'Baixa & Liquidação (Pagar)',
  10: 'Baixa & Liquidação (Receber)',
  11: 'Conta Caixa Padrão',
  12: 'Conta Banco Padrão',
  13: 'Rateio de Classe',
  14: 'Impressão de Cheques',
  15: 'Suprimento de Caixa',
  16: 'Sangria de Caixa',
  17: 'Domínio Padrão',
  18: 'Domínio Financeiro',
  19: 'Cheques Emitidos',
  20: 'Fechamento de Caixa',
  21: 'Índices Econômicos',
  22: 'Fluxo de Caixa',
  23: 'Requisições de Materiais',
  24: 'Devoluções de Materiais',
  25: 'Estornos e Reversões (Pagar)',
  26: 'Estornos e Reversões (Receber)',
  27: 'Grade de Estoque',
  28: 'Matriz e Filiais',
  29: 'Imposto de Renda',
  30: 'Documentos Financeiros',
  31: 'Cadastros Gerais',
  32: 'Filtros de Liquidação',
  33: 'Transferências entre Filiais',
  34: 'Controle de Lote',
  35: 'Controle de Série',
  36: 'Localização Física no Estoque',
  37: 'Venda Completa',
  38: 'Cliente Consumidor Padrão',
  39: 'Vencimento de Parcelas (Orçamentos)',
  40: 'Vencimento de Parcelas (Condicional)',
  41: 'Vencimento de Parcelas (Pedidos)',
  42: 'Vencimento de Parcelas (Vendas)',
  43: 'Estrutura e Composição PAI',
  44: 'Descontos e Acréscimos Automáticos',
  45: 'Ação de Desconto (Grupos Iguais)',
  46: 'Ação de Desconto (Grupos Diferentes)',
  47: 'Cálculos e Arredondamentos',
  48: 'Notas Fiscais Eletrônicas (NFe/NFC-e)',
  49: 'Emissão de Boletos',
  50: 'Fiscal (Partilha de ICMS)',
  51: 'Unidades de Medida',
  52: 'Sugestão de Consumidor na Venda',
  53: 'Fiscal (Simples Nacional)',
  54: 'Fiscal (Crédito Simples Nacional)',
  55: 'Organização de Gôndolas (Base)',
  56: 'Organização de Gôndolas (Secundária)',
  57: 'Fiscal (Validação de NCM)',
  58: 'Fiscal (Origem de Mercadoria)',
  59: 'Integração com Balanças',
};
